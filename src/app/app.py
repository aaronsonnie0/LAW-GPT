            ...
            if st.session_state.vector_store is not None:
                with st.spinner("Analyzing your question..."):
                    ...
                    if retriever is not None:
                        ...
                        st.error("Vector retriever is not available. Please check if chromadb is installed.")
            else:
                st.error("Vector store is not available. Please check if chromadb is installed.")
